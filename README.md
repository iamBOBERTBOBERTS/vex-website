...
- **Elite digital presence v1** (**§0–§30** single source — WebGL §21+, VLR halt, Cox §28 / §28.3, **§29** Cursor **Always** background, **§30** **GLB copy-paste** + **`NEXT_PUBLIC_HERO_VEHICLE_GLB`** + **`--dry-run=text`** + Turbo **warm-up** + **`turbo.json`**): [docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md](docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md)
