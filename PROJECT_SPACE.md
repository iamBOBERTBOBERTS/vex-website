...
- **Elite digital presence v1** (**§0–§30** — WebGL §21+, VLR, Cox §28 / §28.3, **§29** **Always** background, **§30** **GLB + dry-run=text** + **`NEXT_PUBLIC_HERO_VEHICLE_GLB`** + Turbo **warm-up** + **`TURBO_CACHE`** + **`turbo.json`**): `docs/plans/2026-04-04-vex-ELITE-DIGITAL-PRESENCE-v1.md`
