...
export default function InvestorDeckPage() {
  ...
  return (
    <main style={{ maxWidth: 980, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <InvestorNarrativeBlocks variant="deck" />
      ...
      {data && (
        <>
          ...
          {pilot && <InvestorPilotMetricsGrid pilot={pilot} pilotSource={pilotSource} />}
          <InvestorHighlights highlights={data.highlights} />
        </>
      )}

      {!data && pilot && <InvestorPilotMetricsGrid pilot={pilot} pilotSource={pilotSource} />}
